...
func foo(){
    ...
    for a, b := range arr {
        ...
        input = Program([
            FuncDecl("foo",[],VoidType(),Block([
                VarDecl("arr",ArrayType([IntLiteral(2),IntLiteral(3)],IntType()), None),
                VarDecl("a", None,IntLiteral(1)),
                VarDecl("b",ArrayType([IntLiteral(3)],IntType()), None),
                ForEach(Id("a"),Id("b"),Id("arr"),Block([
                    VarDecl("c", IntType(),Id("a")),
                    VarDecl("d", ArrayType([IntLiteral(3)], IntType()), Id("b")),
                    VarDecl("e", ArrayType([IntLiteral(2)], StringType()), Id("a"))]))]))])
...
func foo() {
    ...
    def test_173(self):
        """
var a [2] int = [2][2] int {{1,2}, {2,2}}
        :return:
        """
        input = Program([
            VarDecl("a",ArrayType([IntLiteral(2)],IntType()),
                    ArrayLiteral([IntLiteral(2),IntLiteral(2)],IntType(),[[IntLiteral(1),IntLiteral(2)],[IntLiteral(2),IntLiteral(2)]]))])
        self.assertTrue(TestChecker.test(input,
"Type Mismatch: VarDecl(a,ArrayType(IntType,[IntLiteral(2)]),ArrayLiteral([IntLiteral(2),IntLiteral(2)],IntType,[[IntLiteral(1),IntLiteral(2)],[IntLiteral(2),IntLiteral(2)]]))",
                                         inspect.stack()[0].function))
...
var b [10] int = a;
        ...
        """
        input = Program([
            VarDecl("a",ArrayType([BinaryOp("*",IntLiteral(2),IntLiteral(5))],IntType()), None),
            VarDecl("b",ArrayType([IntLiteral(10)],IntType()),Id("a"))])
        self.assertTrue(TestChecker.test(input, "VOTIEN",
                                         inspect.stack()[0].function))
...
var b [2] int = a;
        ...
        """
        input = Program([
            VarDecl("a",ArrayType([BinaryOp("/",IntLiteral(5),IntLiteral(2))],IntType()), None),
...
var c [15] int = b;
        ...
        """
        input = Program([
            ConstDecl("a",None,BinaryOp("+",IntLiteral(2),IntLiteral(3))),
            VarDecl("b",ArrayType([BinaryOp("+",BinaryOp("*",Id("a"),IntLiteral(2)),Id("a"))],IntType()), None),
            VarDecl("c",ArrayType([IntLiteral(15)],IntType()),Id("b"))])
        self.assertTrue(TestChecker.test(input, "VOTIEN",
                                         inspect.stack()[0].function))
...
func foo(a [1 + 2] int) {
    foo([k - 1] int {1,2,3})
        ...
        """
        input = Program([
            ConstDecl("v",None,IntLiteral(3)),
            ConstDecl("k",None,BinaryOp("+",Id("v"),IntLiteral(1))),
            FuncDecl("foo",[ParamDecl("a",ArrayType([BinaryOp("+",IntLiteral(1),IntLiteral(2))],IntType()))],VoidType(),Block([
                FuncCall("foo",[ArrayLiteral([BinaryOp("-",Id("k"),IntLiteral(1))],IntType(),[IntLiteral(1),IntLiteral(2),IntLiteral(3)])])
            ]))])
        self.assertTrue(TestChecker.test(input, "VOTIEN", inspect.stack()[0].function))
...
const b = a * 5;
        ...
        """
        input = Program([
            ConstDecl("a",None,BinaryOp("+",StringLiteral("2"),StringLiteral("#"))),
            ConstDecl("b",None,BinaryOp("*",Id("a"),IntLiteral(5)))])
...
var d [c] int = [3] int {1,2,3}
        ...
        input = Program([
            ...
            ConstDecl("b",None,UnaryOp("-",Id("a"))),
            ConstDecl("c",None,UnaryOp("-",Id("b"))),
            VarDecl("d",ArrayType([Id("c")],IntType()),
                    ArrayLiteral([IntLiteral(3)],IntType(),[IntLiteral(1),IntLiteral(2),IntLiteral(3)]))])
        self.assertTrue(TestChecker.test(input,
    "VOTIEN", inspect.stack()[0].function))
...
type TIEN struct {
    Votien int;
        ...
        """
        input = Program([
            MethodDecl("v",Id("TIEN"),FuncDecl("Votien",[],VoidType(),Block([Return(None)]))),
            StructType("TIEN",[("Votien",IntType())],[])])
        self.assertTrue(TestChecker.test(input, "Redeclared Method: Votien", inspect.stack()[0].function))
...
func foo() {
    var x VO = TIEN{a:1};
        ...
        input = Program([
            VarDecl("v",Id("TIEN"), None),
            StructType("TIEN",[("a",IntType())],[]),
            InterfaceType("VO",[Prototype("fooA",[],VoidType()),Prototype("fooB",[],VoidType())]),
            MethodDecl("v",Id("TIEN"),FuncDecl("fooA",[],VoidType(),Block([Return(None)]))),
            MethodDecl("v",Id("TIEN"),FuncDecl("fooB",[],VoidType(),Block([Return(None)]))),
            MethodDecl("v",Id("TIEN"),FuncDecl("fooC",[],VoidType(),Block([Return(None)]))),
            FuncDecl("foo",[],VoidType(),Block([
                VarDecl("x",Id("VO"),StructLiteral(
                    "TIEN",[("a",IntLiteral(1))]))
            ]))])
        self.assertTrue(TestChecker.test(input, "VOTIEN", inspect.stack()[0].function))
...
func foo() {
    var x VO = TIEN{a:1};
        ...
        input = Program([
            VarDecl("v",Id("TIEN"), None),
            StructType("TIEN",[("a",IntType())],[]),
            InterfaceType("VO",[Prototype("fooA",[],VoidType()),Prototype("fooB",[],VoidType()),Prototype("fooC",[],VoidType())]),
            MethodDecl("v",Id("TIEN"),FuncDecl("fooA",[],VoidType(),Block([Return(None)]))),
            MethodDecl("fooB",Id("TIEN"),FuncDecl("fooB",[],VoidType(),Block([
                MethCall(Id("fooB"),"fooB",[]),
                Return(None)
            ]))),
            MethodDecl("v",Id("TIEN"),FuncDecl("fooC",[],VoidType(),Block([Return(None)]))),
            FuncDecl("foo",[],VoidType(),Block([
    ...
    for index, value := range  array {
        ...
        input = Program([
            FuncDecl("Votien",[ParamDecl("b",IntType())],VoidType(),Block([
                VarDecl("array", None,ArrayLiteral([IntLiteral(2)],IntType(),[IntLiteral(1),IntLiteral(2)])),
                VarDecl("index", None,FloatLiteral(1.0)),
                VarDecl("value",IntType(), None),
                ForEach(Id("index"),Id("value"),Id("array"),Block([Return(None)]))]
            ))])
        self.assertTrue(TestChecker.test(input, "Type Mismatch: ForEach(Id(index),Id(value),Id(array),Block([Return()]))",
                                         inspect.stack()[0].function))
